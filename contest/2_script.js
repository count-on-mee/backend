...
function parseCoordinates(coordStr) {
  ...
  // 예시: 'N36.960756, E127.043367' 또는 '36.960756,127.043367'
  // 방향 문자 제거 및 공백 제거
...
async function fetchAllItems() {
  ...
  let pageNo = 1;
  while (true) {
    const API_URL = `https://api.kcisa.kr/openapi/API_TOU_052/request?serviceKey=${SERVICE_KEY}&numOfRows=${NUM_OF_ROWS}&pageNo=${pageNo}`;
...
async function main() {
  ...
  fs.writeFileSync('insert_spot_from_api.sql', sql, 'utf-8');
  console.log('SQL 파일이 생성되었습니다: insert_spot_from_api.sql');
}
