...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const spotData = [
      ...
      {
        name: '레뽀드라라 강남점',
        address: '서울 강남구 역삼동 테헤란로7길 22 2관 101호',
        tel: '0507-1352-3177',
        location: Sequelize.fn(
          'ST_GeomFromText',
          'POINT(127.0306576 37.5003173)'
        ),
        naver_spot_id: '1317157725',
        review_count: 814,
        review_score: null,
      },
      {
      ...
      {
        name: '윰드',
        address: '서울 강남구 청담동 도산대로58길 18 1층',
        tel: '02-544-1106',
        location: Sequelize.fn(
          'ST_GeomFromText',
          'POINT(127.0412263 37.5220281)'
        ),
        naver_spot_id: '1759147143',
        review_count: 158,
        review_score: null,
      },
      {
      ...
      {
        name: '% ARABICA 스타필드 코엑스몰점',
        address: '서울 강남구 삼성동 영동대로 513 스타필드 코엑스몰 별마당도서관 지상1층',
        tel: null,
        location: Sequelize.fn(
          'ST_GeomFromText',
          'POINT(127.0600062 37.5098347)'
        ),
        naver_spot_id: '1269340158',
        review_count: 1,
        review_score: null,
      },
      {
      ...
      spotImgData.push(...[
        {
          ...
          image_url: 'https://ldb-phinf.pstatic.net/20240315_10/1710430806746afm5x_JPEG/1111.jpg',
        },
        {
          spot_id: Sequelize.literal(`(SELECT spot_id FROM spot WHERE naver_spot_id = '1342487435' LIMIT 1)`),
          image_url: 'https://ldb-phinf.pstatic.net/20240315_210/1710432069224Jadq0_JPEG/0E4A4750.jpg',
        }
      ]);
    }
    ...
    // 레뽀드라라 강남점 이미지
    const existingImages_1317157725 = await queryInterface.sequelize.query(
      'SELECT COUNT(*) as count FROM spot_img WHERE spot_id = (SELECT spot_id FROM spot WHERE naver_spot_id = ? LIMIT 1)',
      {
        replacements: ['1317157725'],
        type: queryInterface.sequelize.QueryTypes.SELECT
      }
    );

    if (existingImages_1317157725[0].count === 0) {
      // 새 이미지 추가
      spotImgData.push(...[
        {
          spot_id: Sequelize.literal(`(SELECT spot_id FROM spot WHERE naver_spot_id = '1317157725' LIMIT 1)`),
          image_url: 'https://ldb-phinf.pstatic.net/20240423_109/1713883928251floNB_JPEG/%B6%F3%B6%F3_%B4%F5%C5%AC%B7%A1%BD%C4_%C0%CE%BD%BA%C5%B8%B3%D7%C0%CC%B9%F6%BF%EB_%BB%E7%C1%F8_2024.04.07_%B4%EB%C1%F6_1-03.jpg',
        },
        {
          spot_id: Sequelize.literal(`(SELECT spot_id FROM spot WHERE naver_spot_id = '1317157725' LIMIT 1)`),
          image_url: 'https://ldb-phinf.pstatic.net/20240423_96/1713883927693Jw3Bn_JPEG/%B6%F3%B6%F3_%B4%F5%C5%AC%B7%A1%BD%C4_%C0%CE%BD%BA%C5%B8%B3%D7%C0%CC%B9%F6%BF%EB_%BB%E7%C1%F8_2024.04.07_%B4%EB%C1%F6_1-08.jpg',
        }
      ]);
    }
    ...
    // 윰드 이미지
    const existingImages_1759147143 = await queryInterface.sequelize.query(
      'SELECT COUNT(*) as count FROM spot_img WHERE spot_id = (SELECT spot_id FROM spot WHERE naver_spot_id = ? LIMIT 1)',
      {
        replacements: ['1759147143'],
        type: queryInterface.sequelize.QueryTypes.SELECT
      }
    );

    if (existingImages_1759147143[0].count === 0) {
      // 새 이미지 추가
      spotImgData.push(...[
        {
          spot_id: Sequelize.literal(`(SELECT spot_id FROM spot WHERE naver_spot_id = '1759147143' LIMIT 1)`),
          image_url: 'https://ldb-phinf.pstatic.net/20231121_32/17005561800022csIi_JPEG/IMG_4329.JPG',
        },
        {
          spot_id: Sequelize.literal(`(SELECT spot_id FROM spot WHERE naver_spot_id = '1759147143' LIMIT 1)`),
          image_url: 'https://ldb-phinf.pstatic.net/20241103_187/1730590951034TUAFq_JPEG/IMG_3365.jpeg',
        }
      ]);
    }
      ...
      spotImgData.push(...[
        {
          ...
          image_url: 'https://ldb-phinf.pstatic.net/20250319_33/1742368589843m1P8C_PNG/naver_logo.png',
        }
      ]);
    }

    // % ARABICA 스타필드 코엑스몰점 이미지
    const existingImages_1269340158 = await queryInterface.sequelize.query(
      'SELECT COUNT(*) as count FROM spot_img WHERE spot_id = (SELECT spot_id FROM spot WHERE naver_spot_id = ? LIMIT 1)',
      {
        replacements: ['1269340158'],
        type: queryInterface.sequelize.QueryTypes.SELECT
      }
    );

    if (existingImages_1269340158[0].count === 0) {
      // 새 이미지 추가
      spotImgData.push(...[
        {
          spot_id: Sequelize.literal(`(SELECT spot_id FROM spot WHERE naver_spot_id = '1269340158' LIMIT 1)`),
          image_url: 'https://ldb-phinf.pstatic.net/20240614_300/1718327063516w8IER_JPEG/Coex_01.jpg',
        }
      ]);
    }
      ...
      spotImgData.push(...[
        {
          ...
          image_url: 'https://ldb-phinf.pstatic.net/20220916_222/1663307601022vvDSo_JPEG/Screenshot_20220915-222559_KakaoMap.jpg',
        }
      ]);
    }
    ...
    // 레뽀드라라 강남점 카테고리 관계
    const existingCategories_1317157725 = await queryInterface.sequelize.query(
      'SELECT spot_category_id FROM spot_category_relation WHERE spot_id = (SELECT spot_id FROM spot WHERE naver_spot_id = ? LIMIT 1)',
      {
        replacements: ['1317157725'],
        type: queryInterface.sequelize.QueryTypes.SELECT
    ...
    const existingCategoryIds_1317157725 = new Set(existingCategories_1317157725.map(cat => cat.spot_category_id));

    // 중복되지 않는 카테고리만 추가
    const uniqueCategories_1317157725 = [...new Set([
      '카페'
    ])];

    for (const category of uniqueCategories_1317157725) {
      const categoryId = {"식당":1,"카페":2,"숙소":3,"관광지":4,"자연":5,"복합 문화 공간":6,"박물관":7,"미술관":8,"도서관":9,"역사":10,"종교":11};
      if (categoryId[category] && !existingCategoryIds_1317157725.has(categoryId[category])) {
        spotCategoryRelationData.push({
          spot_id: Sequelize.literal(`(SELECT spot_id FROM spot WHERE naver_spot_id = '1317157725' LIMIT 1)`),
          spot_category_id: categoryId[category],
        });
    ...
    // 윰드 카테고리 관계
    const existingCategories_1759147143 = await queryInterface.sequelize.query(
      'SELECT spot_category_id FROM spot_category_relation WHERE spot_id = (SELECT spot_id FROM spot WHERE naver_spot_id = ? LIMIT 1)',
      {
        replacements: ['1759147143'],
        type: queryInterface.sequelize.QueryTypes.SELECT
    ...
    const existingCategoryIds_1759147143 = new Set(existingCategories_1759147143.map(cat => cat.spot_category_id));

    // 중복되지 않는 카테고리만 추가
    const uniqueCategories_1759147143 = [...new Set([
      '카페'
    ])];

    for (const category of uniqueCategories_1759147143) {
      const categoryId = {"식당":1,"카페":2,"숙소":3,"관광지":4,"자연":5,"복합 문화 공간":6,"박물관":7,"미술관":8,"도서관":9,"역사":10,"종교":11};
      if (categoryId[category] && !existingCategoryIds_1759147143.has(categoryId[category])) {
        spotCategoryRelationData.push({
          spot_id: Sequelize.literal(`(SELECT spot_id FROM spot WHERE naver_spot_id = '1759147143' LIMIT 1)`),
          spot_category_id: categoryId[category],
        });
    ...
    // % ARABICA 스타필드 코엑스몰점 카테고리 관계
    const existingCategories_1269340158 = await queryInterface.sequelize.query(
      'SELECT spot_category_id FROM spot_category_relation WHERE spot_id = (SELECT spot_id FROM spot WHERE naver_spot_id = ? LIMIT 1)',
      {
        replacements: ['1269340158'],
        type: queryInterface.sequelize.QueryTypes.SELECT
    ...
    const existingCategoryIds_1269340158 = new Set(existingCategories_1269340158.map(cat => cat.spot_category_id));

    // 중복되지 않는 카테고리만 추가
    const uniqueCategories_1269340158 = [...new Set([
      '카페'
    ])];

    for (const category of uniqueCategories_1269340158) {
      const categoryId = {"식당":1,"카페":2,"숙소":3,"관광지":4,"자연":5,"복합 문화 공간":6,"박물관":7,"미술관":8,"도서관":9,"역사":10,"종교":11};
      if (categoryId[category] && !existingCategoryIds_1269340158.has(categoryId[category])) {
        spotCategoryRelationData.push({
          spot_id: Sequelize.literal(`(SELECT spot_id FROM spot WHERE naver_spot_id = '1269340158' LIMIT 1)`),
          spot_category_id: categoryId[category],
        });
